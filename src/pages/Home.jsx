...
function StatItem({ number, label }) {
	return (
		<div className='py-10 px-6 lg:px-10 text-center border-b lg:border-b-0 lg:border-r border-white/10 last:border-r-0'>
			<div className='font-serif text-4xl lg:text-5xl font-light text-cream mb-2'>
				{number}
			</div>
			<div className='text-xs tracking-[0.2em] uppercase text-cream/50'>
				{label}
			</div>
		</div>
	);
	...
	return (
		<div>
			...
			<section className='bg-charcoal grid lg:grid-cols-3'>
				...
				<StatItem
					number={loading ? "—" : projects.length}
