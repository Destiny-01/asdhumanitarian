...
const adminTeam = [
  { name: 'Queen Sabrina Igbokah', post: 'Social Media Director', image: '/exec(1).jpeg' },
  { name: 'Mike Emadomi Beloved ', post: 'Asst. Social Media Director', image: '/exec(2).jpeg' },
  { name: 'Momodu Abdulrazak', post: 'Public relations officer', image: '/exec(8).jpeg' },
  { name: 'Juliet Alemoh', post: 'Administrator', image: '/exec(3).jpeg' },
  { name: 'Medina Lisa Yahaya', post: 'Administrator', image: '/exec(4).jpeg' },
  { name: 'Princess Joan Osomiame', post: 'Administrator', image: '/exec(5).jpeg' },
  { name: 'Christiana Isomine Omomia', post: 'Administrator', image: '/exec(6).jpeg' },
...
const stats = [
  { value: '5', label: 'Years of Operation', desc: 'Building trust and programs that last since 2020.' },
...
export default function About() {
  ...
  return (
    <div>
        ...
        <div className="mt-16">
          ...
          <div className="flex gap-7 overflow-x-auto pb-4">
            {adminTeam.map(({ name, post, image }) => (
              <div key={name} className="min-w-[260px] max-w-[260px] text-center flex-shrink-0">
                <img src={image} alt={name} className="w-full aspect-square object-cover object-top rounded mb-5" />
        ...
        <div className="mt-20">
          ...
          <div className="flex gap-7 overflow-x-auto pb-4">
            {leadershipTeam.map((member) => (
              <div key={member.name} className="relative min-w-[260px] max-w-[260px] text-center flex-shrink-0">

                <img src={member.image} alt={member.name} className="w-full aspect-square object-cover object-top rounded mb-5" />
                ...
                <button
                  ...
                  className="absolute bottom-0 right-0 text-[0.7rem] text-green hover:underline"
                >
                  Read bio
                </button>
      ...
      {selectedLeader && (
  <div
    className="fixed inset-0 z-50 flex items-center justify-center backdrop-blur-md bg-black/30 px-6"
    onClick={closeModal}
  >
    <div
    ...
    >
      ...
      <div className="flex flex-col md:flex-row h-full min-h-0 flex-1">
        ...
        <div className="w-full md:w-1/2 h-[220px] md:h-full flex-shrink-0">
          <img
